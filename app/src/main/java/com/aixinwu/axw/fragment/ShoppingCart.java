...
public class ShoppingCart extends Fragment {
    ...
    /* 结算 */
    private ButtonBarLayout mBtnChecking;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                case MSG_WHAT:
                    mAdapter = new ShoppingCartAdapter(getActivity(), mDatas);
    ...
    private void initViews(View view) {
        ...
        mListView = (ListView) view.findViewById(R.id.lv_shopping_cart_activity);
        mBtnChecking = (ButtonBarLayout) view.findViewById(R.id.btn_activity_shopping_cart_clearing);
        ...
        BtnDelChecked = (Button) view.findViewById(R.id.btn_delete_selected_product);
        BtnDelAll = (Button) view.findViewById(R.id.btn_delete_all_product);
